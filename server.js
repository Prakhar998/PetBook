...
//when the app launches make sure public/uploaded photo exist
...
function passwordProtected(req, res, next) {
    res.set("WWW-Authenticate", "Basic realm='PetBook'")
...
async function start(){
    const client=new MongoClient("mongodb://root:root@localhost:27017/AmazingApp?&authSource=admin")
